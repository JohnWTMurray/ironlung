...
execute_process(
  COMMAND "/usr/bin/git" show-ref "6ea2dec23c3df14ac3b27b7d2d6bbff0cb7ba1b0"
  WORKING_DIRECTORY "/home/risk/ironlung/build/_deps/cpr-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/risk/ironlung/build/_deps/cpr-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/risk/ironlung/build/_deps/cpr-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
